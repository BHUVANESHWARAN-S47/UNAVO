    ...
    <footer className="bg-gray-900 text-gray-300 pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* About */}
          <div>
            <h2 className="text-white text-xl font-bold mb-4">UNAVO</h2>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-primary-400 transition">Team</a></li>
              <li><a href="#" className="hover:text-primary-400 transition">UNAVO One</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-primary-400 transition">Partner with us</a></li>
              <li><a href="#" className="hover:text-primary-400 transition">Ride with us</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-primary-400 transition">Investor Relations</a></li>
            </ul>
          </div>
        </div>
