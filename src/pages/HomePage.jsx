...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-green-500 via-emerald-500 to-white py-12 md:py-24 relative overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          <motion.div 
            className="absolute top-10 left-10 w-72 h-72 bg-white rounded-full mix-blend-multiply filter blur-3xl opacity-10"
            animate={{
              x: [0, 30, -20, 30, 0],
              y: [0, -30, 20, -30, 0],
            }}
          ...
          />
          <motion.div 
            className="absolute -bottom-8 right-10 w-72 h-72 bg-green-300 rounded-full mix-blend-multiply filter blur-3xl opacity-10"
            animate={{
              x: [0, -30, 20, -30, 0],
              y: [0, 30, -20, 30, 0],
            }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <motion.span 
              className="block text-white mt-2 font-black drop-shadow-lg"
          ...
          >
            {offers.map((offer) => (
              <OfferCard 
                ...
                route={offer.id === 2 ? '/free-delivery' : null}
              />
            ))}
          </motion.div>
        </div>
